...
<form >
    <fieldset>
        <legend align="center">Generate RFQ Report</legend>
        <table>
            <tr>
                <td>
                    <fieldset>
                    ...
                    <fieldset>
                        ...
                        <table>
                            <tr>
                                ...
                                <td><input type="checkbox" name="partDesc" value="partDesc" checked>Part Description
                                </td>
                        ...
                        <button type="submit" formaction="authenreportrfq.php">Generate Detailed Report</button>
                    </fieldset>
                    <fieldset>
                        ...
                        <button onclick="myFunction()">Cancel</button>
                        <button type="submit" formaction="authenreportrfq1.php">Generate Summary Report</button>
